...
class Yelocar:
    ...
    def pid_vehicle(model, masked, theta_cam, last_time, vel):
        ...
        # print('theta_dot : {:.4f}, theta : {:.4f}, velocity : {:.4f}'.format(theta_dot, theta, vel))
        # f1.write('theta_dot : {:.4f}, theta : {:.4f}, velocity : {:.4f}\n'.format(theta_dot, theta, vel))
